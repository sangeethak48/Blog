...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Create a new category for organizing blog posts</p>
        </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    <p class="mt-1 text-sm text-gray-500">Optional: Provide a brief description (max 500 characters)</p>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18.169 12.476l-4.604-4.604a2 2 0 00-2.828 0L9 8.393V4a2 2 0 00-2-2H4a2 2 0 00-2 2v3a2 2 0 002 2h4.393l.717.717a2 2 0 000 2.828l4.604 4.604a2 2 0 102.828-2.828zM16 10a2 2 0 11-4 0 2 2 0 014 0z" clip-rule="evenodd"/>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('admin.categories.index') }}" class="flex-1 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-200 text-center">
                        Cancel
                    </a>
                    <button type="submit" class="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-200">
                        Create Category
                    </button>
                </div>
